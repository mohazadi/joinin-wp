...
if ( ! class_exists( 'JoinIN_Uninstall' ) ) {
	class JoinIN_Uninstall {
		...
		/**
		 * Remove joinin specific options.
		 *
		 * @since 3.0.0
		 */
		private static function remove_options() {
			delete_option( 'joinin_url' );
			delete_option( 'joinin_salt' );
			delete_option( 'joinin_plugin_version' );
			delete_option( 'joinin_default_roles_set' );
		}
	}
}
JoinIN_Uninstall::uninstall();
